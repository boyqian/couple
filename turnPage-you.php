      ...
      $page=2017;
       ...
       // $showPage=(2017%$page)*$limitSql;
        $sql="SELECT * FROM img_you WHERE img_year='$page' ORDER BY img_id DESC";
       //  LIMIT ".$showPage.",$limitSql";
...
?>
    ...
    多用if语句就好
                  ...
                  for($i=0;$i<$img_length;$i++) {
                      $img=$img_src[$i];
                      ?>
                      <img src=<?php echo $img;?> alt='#' class='lightbox-pic' 
                      data-role='lightbox' 
                      data-source='<?php echo $img;?>'
                      data-group='group-1'
                      data-id='<?php echo $re['img_id'];?>' 
                      data-caption='<?php echo $re['img_belong'];?>'
